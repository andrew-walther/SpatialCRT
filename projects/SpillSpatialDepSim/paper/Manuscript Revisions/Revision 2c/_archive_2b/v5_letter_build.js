...
children.push(new Paragraph({ alignment: AlignmentType.CENTER, spacing: { after: 40 },
  children: [new TextRun({ text: "BMC Medical Research Methodology — Second Revision", size: 22 })] }));
children.push(new Paragraph({ alignment: AlignmentType.CENTER, spacing: { after: 40 },
...
children.push(new Table({
  ...
  rows: [
    ...
    new TableRow({ children: [
      ...
      bodyCell(cellParas(["§3.2 (p. 17); §5.2 (p. 33)"]), 2320),
    ]}),
    new TableRow({ children: [
      ...
      bodyCell(cellParas(["§4.4 (p. 27); §5.1 (p. 30)"]), 2320),
    ]}),
    new TableRow({ children: [
      ...
      bodyCell(cellParas(["§5.2 (p. 33); §5.3 (p. 35)"]), 2320),
    ]}),
  ],
}));
...
children.push(itemTable(
  ...
  [
    "§2.3.1 (p. 8); β/ψ/ρ estimands paragraph and reduced-form Eq. (4) in §2.5 (p. 12); scope note in §5.2 (p. 33).",
...
children.push(itemTable(
  ...
  [
    "SAR model and notation block, §2.5, Eqs. (1)–(6) (p. 12); spatial-dependence term §2.6 (p. 13); weights construction Appendix A.",
...
children.push(itemTable(
  ...
  [
    "Estimation-model paragraph in §3.2 (p. 17); identifiability framing in §5.2 (p. 33); Eq. (6); Tables 1–3.",
...
children.push(itemTable(
  ...
  [
    "Inferential-scope block in §3.1 (p. 16); inference-constraint paragraph in §5.2 (p. 33).",
...
children.push(itemTable(
  ...
  [
    "Severity quantification in §5.2 (p. 33); conditional recommendation in §4.4 (p. 27); buffer-zone paragraph in §5.3 (p. 35).",
...
children.push(para(rich("The table below consolidates all revisions made for this round, with locations in Revisions_V2b.pdf."), { after: 120 }));
...
children.push(new Table({
  ...
  rows: [
    new TableRow({ tableHeader: true, children: [
      headerCell("ID", SUMC[0]), headerCell("Change Summary", SUMC[1]), headerCell("Location (Revisions_V2b)", SUMC[2]),
    ]}),
    ...
    sumRow("C1", "Removed “total treatment effect” claim; β redefined as the direct structural coefficient; added estimands paragraph and reduced-form Eq. (4) showing E[Y(0,1)]−E[Y(0,0)] is a derived quantity, not any single parameter; “causal” removed from ψ.", "§2.3.1 (p. 8); §2.5 + Eq. (4) (p. 12); §5.2 (p. 33)"),
    ...
    sumRow("C3", "Fixed all seven notation items (a–g): defined w_ij; harmonized ik / cluster indexing; carried cluster index through Eqs. (1)–(6); declared W cluster-level n×n; scalar ψ; removed redundant set indexing; matched Eqs. (5)–(6) summation form.", "§2.5–2.6, Eqs. (1)–(6) (pp. 12–13); App. A"),
    sumRow("C4", "Stated the estimated model explicitly: α, β, ψ, ρ jointly estimated via SAR MLE with both x_i and z_i included; explained the ≈−ψ bias under collinearity, matching Tables 1–3.", "§3.2 (p. 17); §5.2 (p. 33)"),
    sumRow("C5", "Conceded that BSS (2–6 allocations) supports no randomization/permutation inference; clarified that model-based SAR MLE conditions on the realized allocation and is the valid framework; reframed near-determinism as the deliberate allocation mechanism.", "§3.1 (p. 16); §5.2 (p. 33)"),
    sumRow("C6", "Quantified bias severity (50–80% of β; answers Editor’s annotation); contextualized as identifiability bias common to equally collinear SRS; made BSS recommendation conditional; added buffer-zone designs to Future Considerations.", "§5.2 (p. 33); §4.4 (p. 27); §5.3 (p. 35)"),
  ],
}));
