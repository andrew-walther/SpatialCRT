...
write.csv(beta.mse, "beta_mse/beta_mse_results_TrtNoSpill_3x3_A02_B1_P08_R00.csv", row.names = TRUE)
write.csv(alpha.mse, "alpha_mse/alpha_mse_results_TrtNoSpill_3x3_A02_B1_P08_R00.csv", row.names = TRUE)
write.csv(psi.mse, "psi_mse/psi_mse_results_TrtNoSpill_3x3_A02_B1_P08_R00.csv", row.names = TRUE)
write.csv(rho.mse, "rho_mse/rho_mse_results_TrtNoSpill_3x3_A02_B1_P08_R00.csv", row.names = TRUE)
