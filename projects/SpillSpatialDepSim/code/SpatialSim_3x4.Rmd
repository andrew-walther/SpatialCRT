...
alpha <- 0.2 # intercept/baseline effect
beta <- 1 # consider a range of intervention effects (start with Null case -> 1)
psi <- 0.5 # maximum spillover effect (binary) (options: 0.5, 0.6, 0.7, 0.8)
rho <- 0.01 # spatial correlation parameter (options: 0.00, 0.01)
...
write.csv(beta.mse, "../results/beta_mse/beta_mse_results_TrtNoSpill_3x4_A02_B1_P05_R001.csv", row.names = TRUE)
write.csv(alpha.mse, "../results/alpha_mse/alpha_mse_results_TrtNoSpill_3x4_A02_B1_P05_R001.csv", row.names = TRUE)
write.csv(psi.mse, "../results/psi_mse/psi_mse_results_TrtNoSpill_3x4_A02_B1_P05_R001.csv", row.names = TRUE)
write.csv(rho.mse, "../results/rho_mse/rho_mse_results_TrtNoSpill_3x4_A02_B1_P05_R001.csv", row.names = TRUE)
