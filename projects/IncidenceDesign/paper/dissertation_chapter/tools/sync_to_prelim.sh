...
#      something changed). The rendered draft/project2-incidence-draft.pdf is
#      added only when this run rendered it AND some other Chapter 3 path
...
PDF_REL="$TARGET_REL/draft/project2-incidence-draft.pdf"
