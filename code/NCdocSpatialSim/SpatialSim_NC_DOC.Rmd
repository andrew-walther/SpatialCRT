...
rho <- 0.00 # spatial correlation parameter t
...
## Random Sampling ##
RandomAlphas <- as.matrix(colMeans(alpha_estimates))
RandomBetas <- as.matrix(colMeans(beta_estimates))
#RandomPsis <- as.matrix(colMeans(psi_estimates))
RandomRhos <- as.matrix(colMeans(rho_estimates))

RandomAlphasSE <- as.matrix(colMeans(alpha_estimates_SE))
RandomBetasSE <- as.matrix(colMeans(beta_estimates_SE))
#RandomPsisSE <- as.matrix(colMeans(psi_estimates_SE))
RandomRhosSE <- as.matrix(colMeans(rho_estimates_SE))

## Block Stratification (28 & 43) ##
BlockAlphas <- as.matrix(colMeans(alpha_estimates[,c(28, 43)]))
BlockBetas <- as.matrix(colMeans(beta_estimates[,c(28, 43)]))
#BlockPsis <- as.matrix(colMeans(psi_estimates[,c(28, 43)]))
BlockRhos <- as.matrix(colMeans(rho_estimates[,c(28, 43)]))

BlockAlphasSE <- as.matrix(colMeans(alpha_estimates_SE[,c(28, 43)]))
BlockBetasSE <- as.matrix(colMeans(beta_estimates_SE[,c(28, 43)]))
#BlockPsisSE <- as.matrix(colMeans(psi_estimates_SE[,c(28, 43)]))
BlockRhosSE <- as.matrix(colMeans(rho_estimates_SE[,c(28, 43)]))
```
