...
NeighborDist <- 50 # set maximum distance for two points to be considered "neighbors" (shrink???)
...
for(i in 1:N){
  ...
  response.ind <- solve(A.ind, linear_response) # (I - rho W)^(-1) * (linear_response)
